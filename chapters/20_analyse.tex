...
Spaziergehende und Hundebesitzende legen den Fokus primär auf sichtbare Unterstützung bei Dunkelheit, schnelle Hilfe im Notfall und eine besonders einfache, hürdenfreie Bedienung. Da diese Zielgruppe digitale Anwendungen für ihre Aktivitäten seltener nutzt als beispielsweise Laufende oder Radfahrende, ist von einer geringeren Technikaffinität auszugehen. Eine intuitive Benutzeroberfläche ist daher von entscheidender Bedeutung.
...
Die erhobenen Daten wurden aus SoSci in RStudio importiert und dort ausgewertet.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Risiken.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Risiken_weiblich.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Risiken_maennlich.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Faktoren.png} 
...
Outdoor-Aktivitäten nutzen würden, wurde mittels einer fünfstufigen Likert-Skala erfasst. Die Likert-Skala umfasste die Antwortmöglichkeiten "`auf keinen Fall”, "`wahrscheinlich nicht”, "`vielleicht”, "`wahrscheinlich”, "`auf jeden Fall”. Die Ergebnisse zeigen eine klare Tendenz zur App-Nutzung (siehe \autoref{fig:nutzung}). 77,7\% der Befragten gaben an, die App wahrscheinlich (30,4\%), vielleicht (33\%) oder auf jeden Fall (14,3\%) nutzen zu wollen. Lediglich 5,4\% würden die App auf keinen Fall nutzen. Frauen (siehe \autoref{fig:nutzung_weiblich}) zeigen eine doppelt so hohe App-Nutzungsbereitschaft wie Männer (siehe \autoref{fig:nutzung_männlich}). Insgesamt zeigt die "`Gruppe unsicher"' (siehe \autoref{fig:nutzung_unsicher}) die mit Abstand höchste und die männlichen Befragten die niedrigste Nutzungsbereitschaft.
...
\begin{itemize}
    ...
    \item Niederschwelliger Zugriff auf Status-Updates ohne Notwendigkeit einer eigenen App-Installation für Angehörige
    \item Datenschutz
\end{itemize}
...
Aus den Ergebnissen der Umfrage geht hervor, dass es einen grundsätzlichen Bedarf an einer Sicherheits-App für Outdoor-Aktivitäten gibt und diese auch realistisch häufig genutzt werden würde.
