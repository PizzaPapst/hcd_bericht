...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.73\textwidth]{figures/Checkliste.png} 
...
Basierend auf den entwickelten Personas (Laura, Rosa, Markus) werden konkrete Nutzungsszenarien erstellt, die zeigen, wie die App in realen Situationen eingesetzt wird:
