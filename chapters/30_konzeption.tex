...
\item \textbf{Häufig genutzte Anwendungen:} Outdooractive, adidas Running, Bergfex Wetter, Google Maps, Signal
...
\item \textbf{Häufig genutzte Anwendungen:} WhatsApp, Komoot, Google Maps, Wetter.com, Strava und Garmin Connect
...
Die vorliegende Matrix (siehe Abbildung \ref{fig:matrix}) analysiert die Anforderungen an eine neue Sicherheits-App am Beispiel der Trailrunnerin Rosa Leitner. Sie verdeutlicht den Übergang von einer risikobehafteten IST-Situation zu einer technologisch gestützten SOLL-Situation.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Aufgabenanalysematrix.jpg}
    \caption{Aufgabenanalyse-Matrix der Sicherheits-App, Szenario Rosa Leitner}
    \label{fig:matrix}
\end{figure}
