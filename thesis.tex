...
\begin{document}
    ...
    \include{chapters/20_analyse}
    \include{chapters/30_konzeption}
    \include{chapters/40_entwicklung}
    \include{chapters/50_evaluation}
    \include{chapters/60_Einführungsprozess}
    \include{chapters/70_fazitAusblick}
    ...
    \begin{appendix}
        ...
        % \footnotesize
        \input{appendices/onlineUmfrage.tex}
        \input{appendices/link.tex}
        \input{appendices/prototyp.tex}
        \input{appendices/evaluation.tex}
        % \input{appendices/autoAnalyseWAVE.tex}
        % \input{appendices/autoAnalyseLighthouse.tex}
        % \input{appendices/manuellStartseite.tex}
        % \input{appendices/manuellBarrierefrei.tex}
        % \input{appendices/manuellGezeiten.tex}
